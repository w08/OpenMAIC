export const settingsZhCN = {
  settings: {
    ...
    copilotLogin: '使用 GitHub 登录',
    copilotLogout: '退出登录',
    copilotReLogin: '重新登录',
    copilotRequesting: '正在请求设备码...',
    copilotVisitUrl: '请访问以下网址并输入验证码完成授权：',
    copilotWaiting: '等待授权中...',
    copilotLoginSuccess: '登录成功！',
    copilotRetry: '重试',
    copilotLoggedIn: 'GitHub Copilot 已认证',
    copilotValidating: '验证中...',
    copilotTokenValid: 'Copilot Token 有效',
    copilotTokenInvalid: 'Copilot Token 无效，请重新登录',
    copilotSaveToServer: '共享 Token 给服务端',
    copilotSaveToServerDesc: '将 GitHub Token 保存到本地，以便服务端接口（如课堂生成）也能使用 GitHub Copilot',
    copilotSaveToServerBtn: '保存到服务端',
    copilotClearFromServer: '清除',
    copilotSavedToServer: 'Token 已保存 — 服务端可使用 GitHub Copilot',
    copyCode: '复制',
    copied: '已复制！',
    cancel: '取消',
  },
...
export const settingsEnUS = {
  settings: {
    ...
    copilotLogin: 'Login with GitHub',
    copilotLogout: 'Logout',
    copilotReLogin: 'Re-login',
    copilotRequesting: 'Requesting device code...',
    copilotVisitUrl: 'Visit the URL below and enter the code to authorize:',
    copilotWaiting: 'Waiting for authorization...',
    copilotLoginSuccess: 'Login successful!',
    copilotRetry: 'Try again',
    copilotLoggedIn: 'GitHub Copilot authenticated',
    copilotValidating: 'Validating...',
    copilotTokenValid: 'Copilot token is valid',
    copilotTokenInvalid: 'Copilot token is invalid, please re-login',
    copilotSaveToServer: 'Share token with server',
    copilotSaveToServerDesc: 'Save the GitHub token locally so the server can use GitHub Copilot for API calls (e.g. classroom generation)',
    copilotSaveToServerBtn: 'Save to server',
    copilotClearFromServer: 'Clear',
    copilotSavedToServer: 'Token saved — server can use GitHub Copilot',
    copyCode: 'Copy',
    copied: 'Copied!',
    cancel: 'Cancel',
  },
